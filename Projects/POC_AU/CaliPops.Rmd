...
datapoint[["abPrev"]] <- 
  cbind.data.frame(year = rep(POC_AU$simY, length(POC_AU$popNames) + 1), 
                   indicator = c(POC_AU$popNames, "Prisons"), 
                   realpop = c(32, NA, NA, NA, NA, 27.8),
                   low= c(NA, NA, NA, NA, NA, NA),
                   up = c(NA, NA, NA, NA, NA, NA))
```
...
totalPop_plot <- indicatorPlot(POC_AU, total_N, 
  ...
  scale_y_continuous(limits = c(0,575000)) + 
...
```{r echo=FALSE, warning=FALSE, message=FALSE,  fig.height= 9, fig.width = 12, fig.cap = "" }
ggpubr::ggarrange(Inc_incar_plot, Inc_release_plot) + 
  theme(plot.margin = margin(0.1,0.1,0.1,0.1, "cm")) 
...
\newpage 
## Calibration HCV epidemic
(10) HCV seroprevalence in each subgorup  (Figure 10. )
(11) HCV seroprevalence in community/prisons (Figure 11. ) 
(12) HCV RNA prevalence in each subgorup  (Figure 12. )
(13) HCV RNA prevalence in community/prisons (Figure 13. ) 
(14) HCV incidence in each subgorup  (Figure 14. )
(15) HCV incidence in community/prisons (Figure 15. ) 
...
##Figure10. HCV seroprevalence  
```{r echo=FALSE, warning=FALSE, message=FALSE,  fig.height= 9, fig.width = 12, fig.cap = "" }
ggpubr::ggarrange(popPrevPlot) + 
  theme(plot.margin = margin(0.1,0.1,0.1,0.1, "cm")) 

```
\newpage 

##Figure11. HCV seroprevalence by setting
```{r echo=FALSE, warning=FALSE, message=FALSE,  fig.height= 9, fig.width = 12, fig.cap = "" }
ggpubr::ggarrange(settingPrevPlot ) + 
  theme(plot.margin = margin(0.1,0.1,0.1,0.1, "cm")) 
...
##Figure12. HCV RNA prevalence by subgroups
```{r echo=FALSE, warning=FALSE, message=FALSE,  fig.height= 9, fig.width = 12, fig.cap = "" }
ggpubr::ggarrange(popPrevRNAPlot) + 
  theme(plot.margin = margin(0.1,0.1,0.1,0.1, "cm")) 
...
##Figure13. HCV RNA prevalence by setting
```{r echo=FALSE, warning=FALSE, message=FALSE,  fig.height= 9, fig.width = 12, fig.cap = "" }
ggpubr::ggarrange(settingPrevRNAPlot) + 
  theme(plot.margin = margin(0.1,0.1,0.1,0.1, "cm")) 
...
##Figure14. HCV incidence  
```{r echo=FALSE, warning=FALSE, message=FALSE,  fig.height= 9, fig.width = 12, fig.cap = "" }
ggpubr::ggarrange(popIncPlot ) + 
  theme(plot.margin = margin(0.1,0.1,0.1,0.1, "cm")) 
...
##Figure15. HCV incidence by settings  
```{r echo=FALSE, warning=FALSE, message=FALSE,  fig.height= 9, fig.width = 12, fig.cap = "" }
ggpubr::ggarrange(settingIncPlot ) + 
  theme(plot.margin = margin(0.1,0.1,0.1,0.1, "cm")) 
