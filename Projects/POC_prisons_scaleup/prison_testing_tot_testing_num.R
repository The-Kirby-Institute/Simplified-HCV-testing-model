...
fm[["2025"]] <- c(1.1, 1.1, 1.1, 1.1, 1)
fm[["2026"]] <- c(1.1, 1.1, 1.1, 1.1, 1)
fm[["2027"]] <- c(1.1, 1.1, 1.1, 1.1, 1)
fm[["2028"]] <- c(1.1, 1.1, 1.1, 1.1, 1)
fm[["2029"]] <- c(1.1, 1.1, 1.1, 1.1, 1)
fm[["2030"]] <- c(1.1, 1.1, 1.1, 1.1, 1)
...
scen3 <- run_NP_scenario(
  ...
  target_tests   = list(
    "2025" = list(C = 11000, P = 14000),
    "2026" = list(C = 11000, P = 20000),
    "2027" = list(C = 13750, P = 35000),
    "2028" = list(C = 16500, P = 40000),
    "2029" = list(C = 19250, P = 50000),
    "2030" = list(C = 22000, P = 50000)
  ),
  pj = POC_AU, fs_base = fs, prev_model_base = res_2024,
  dfList_NP_base = dfList_NP_2024,
  Ccal = Ccal, fm = fm, frac_test = frac_test, NPlst = NPlst,
